...
document.addEventListener("DOMContentLoaded", function () {
  ...
  // Close menu when clicking normal links (NOT dropdown toggle)
  document
    .querySelectorAll("#navbarSupportedContent .nav-link:not(.dropdown-toggle)")
    .forEach(link => {
  ...
  document
    .querySelectorAll("#navbarSupportedContent .dropdown-item")
    .forEach(item => {
