Ungaloda `main.js` file-la oru **mukkiyamana thappu** irukku.

Neenga fix panna code-ai kadasila (lines 368+) potrukkinga, **AANA** adhuku mela (lines 334-339) innum andha **pazhaya problem code** apdiye irukku.

Indha pazhaya code, neenga click pannum podhu dropdown-ai open panna vidama **thirumba close pannidum**.

Idho, **Full Clean & Fixed `main.js**`. Idhula andha duplicate problem-ai remove pannitu, dropdown fix-ai correct-ana idathula serthu irukken. Idhai apdiye **Full Replace** pannunga.

### ✅ Final `main.js` Code (Copy & Replace)
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  if (toggler && navCollapse) {
    ...
    // 2. Close Menu ONLY when regular links are clicked (Not dropdowns)
    document.querySelectorAll("#navbarSupportedContent .nav-link").forEach(link => {
      link.addEventListener("click", () => {
        // === MUKKIYAMANA FIX ===
        // Dropdown toggle-ai click panna, menu close aaga koodadhu
